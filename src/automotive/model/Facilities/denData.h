...
public:
  ...
  void setDenmMandatoryFields (long detectionTime_ms, double latReference_deg,
                               double longReference_deg);
  void setDenmMandatoryFields (long detectionTime_ms, double latReference_deg,
                               double longReference_deg, double altitude_m);
  void setDenmMandatoryFields_asn_types (TimestampIts_t detectionTime,
                                         ReferencePosition_t eventPosition);
  ...
  */
  ...
  void
  setDenmMessageID (long messageID)
  {
    m_header.messageID = messageID;
  }
  void
  setDenmProtocolVersion (long protocolVersion)
  {
    m_header.protocolVersion = protocolVersion;
  }
  void
  setDenmStationID (unsigned long stationID)
  {
  ...
  void setDenmMandatoryFields (unsigned long originatingStationID, long sequenceNumber,
  ...
  /* Header getters */
  long
  getDenmHeaderMessageID ()
  {
    return m_header.messageID;
  }
  long
  getDenmHeaderProtocolVersion ()
  {
    return m_header.protocolVersion;
  }
  long
  getDenmHeaderStationID ()
  {
    return m_header.stationID;
  }

  /* Container getters */
  denDataHeader
  getDenmHeader_asn_types ()
  {
    return m_header;
  }
  denDataManagement
  getDenmMgmtData_asn_types ()
  {
    return m_management;
  }
  DENDataItem<denDataSituation>
  getDenmSituationData_asn_types ()
  {
    return m_situation;
  }
  DENDataItem<denDataLocation>
  getDenmLocationData_asn_types ()
  {
    return m_location;
  }
  DENDataItem<denDataAlacarte>
  getDenmAlacarteData_asn_types ()
  {
    return m_alacarte;
  }

  bool
  isDenmSituationDataSet ()
  {
    return m_situation.isAvailable ();
  }
  bool
  isDenmLocationDataSet ()
  {
    return m_location.isAvailable ();
  }
  bool
  isDenmAlacarteDataSet ()
  {
    return m_alacarte.isAvailable ();
  }

  long
  getDenmMgmtDetectionTime ()
  {
    return m_management.detectionTime;
  }

  long
  getDenmMgmtValidityDuration ()
  {
  ...
  getDenmMgmtLatitude ()
  {
    return m_management.latitude;
  }
  long
  getDenmMgmtLongitude ()
  {
    return m_management.longitude;
  }
  long
  getDenmMgmtAltitude ()
  {
    return m_management.altitude.getValue ();
  }
  ...
  void
  setDenmRepetition (uint32_t repetitionDuration, uint32_t repetitionInterval)
  {
    m_internals.repetitionInterval = repetitionInterval;
    m_internals.repetitionDuration = repetitionDuration;
  }
  void
  setDenmRepetitionInterval (uint32_t repetitionInterval)
  {
    m_internals.repetitionInterval = repetitionInterval;
  }
  void
  setDenmRepetitionDuration (uint32_t repetitionDuration)
  {
    m_internals.repetitionDuration = repetitionDuration;
  }
  ...
  /* Internal getters */
  uint32_t
  getDenmRepetitionDuration ()
  {
    return m_internals.repetitionDuration;
  }
  uint32_t
  getDenmRepetitionInterval ()
  {
    return m_internals.repetitionInterval;
  }

  /* Container setters */
  void
  setDenmMgmtData_asn_types (denDataManagement management)
  {
    m_management = management;
  }
  void
  setDenmSituationData_asn_types (denDataSituation situation)
  {
    m_situation.setData (situation);
  }
  void
  setDenmLocationData_asn_types (denDataLocation location)
  {
    m_location.setData (location);
  }
  void
  setDenmAlacarteData_asn_types (denDataAlacarte alacarte)
  {
